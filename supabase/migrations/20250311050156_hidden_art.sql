/*
  ...
  1. Data Changes
    - Insert 10 sample student records with diverse course selections
    - Uses ON CONFLICT DO NOTHING to handle potential duplicates
    - Includes basic student information: name, email, phone, date of birth, and course

  2. Notes
    - Sample data is added for testing and demonstration purposes
    - Email addresses are unique to prevent conflicts
*/
